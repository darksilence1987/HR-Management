...
import static org.team3.exception.ErrorType.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CorporationServiceException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleMonolithicException(CorporationServiceException ex){
    ...
    public final ResponseEntity<ErrorMessage> handlePSQLException(
        ...
        ErrorType errorType = SIRKET_ZATEN_KAYITLI;
        return new ResponseEntity<>(createError(errorType, exception), errorType.getHttpStatus());
    }
