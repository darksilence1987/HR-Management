...
function Chart() {
    return (
                        ...
                        <div className="container-fluid px-4">
                            ...
                            <div className="card mb-4">
                                <div className="card-body">
                                    ...
                                    template. The charts below have been customized - for further customization options,
            ...
            <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js"
                    crossOrigin="anonymous"></script>
            <script src="../../public/assets/demo/chart-area-demo"></script>
            <script src="../../public/assets/demo/chart-bar-demo"></script>
            <script src="../../public/assets/demo/chart-pie-demo"></script>
            </body>
