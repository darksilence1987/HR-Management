...
import UserListforManager from "../userlist/UserListforManager";
    ...
    return (
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div className="container-fluid px-4 ">
                        <div className="container" style={{paddingTop: "50px"}}>
                            ...
                            <Button style={{position: 'absolute', left: '300px', top: '70px', fontSize: "20px"}}
                                ...
                                userRole === "Manager" ? <>
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={10}>
                                            ...
                                            <br/>
                                            <div className="card"
                                                 style={{width: "100%", backgroundColor: "#ff6504" ,marginLeft: "10%"}}>
                                ...
                                userRole === "Admin" ? <>
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={10}>
                                            ...
                                            <br/>
                                            <div className="card"
                                                 style={{width: "100%", backgroundColor: "#feaf51",marginLeft: "10%"}}>
                                                <h1 className="mt-4 h3"
                                                ...
                                                <div className="card-body"
                                                    ...
                                                    <UserListforManager
                                                        style={{width: "100%"}}></UserListforManager>
                                                </div>
                                            </div>
                                        </Grid>
                                    </Grid>
                                ...
                                <>
                                    <Grid container spacing={2}>
                                        <Grid item xs={10}>
                                            ...
                                            <br/>
                                            <div className="card"
                                                 style={{width: "100%", backgroundColor: "#fc864d",marginLeft: "10%"}}>
                                                <h1 className="mt-4 h3"
                ...
                <footer className="py-4 bg-secondary.bg-gradient mt-auto" >
                    <div className="container-fluid px-4"  >
                        <div className="d-flex align-items-center justify-content-between small ">
                            <div className="text-white" >Copyright &copy; Your Website 2022</div>
