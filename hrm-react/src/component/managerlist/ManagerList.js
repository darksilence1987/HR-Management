...
import {findallManager} from "../../store/features/UserSlice";
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Manager Information</Modal.Title>
                </Modal.Header>
                        ...
                        <MDBCard style={{ borderRadius: '15px' }}>
                            <MDBCardBody className="text-center">
                                ...
                                <MDBCardText className="text-muted mb-4">
                                    {userInfo.phone} <span className="mx-2">|</span> <a href="src/component/lists/UserList#!">{userInfo.email}</a>
                                </MDBCardText>
